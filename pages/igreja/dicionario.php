		<div class="container">
			...
			<div class="row g-5">
				<div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
					<h2 class="display-8 mb-4">Dicionário Biblico online</h2>
					<p>Bem-vindo ao nosso Dicionário Bíblico online! Aqui você encontrará definições e explicações sobre termos, personagens e eventos da Bíblia. Navegue pelos nossos artigos e aprofunde seu conhecimento sobre a Palavra de Deus.</p>
					<p>Utilize a barra de rolagem para encontrar rapidamente o que você precisa ou explore nossas categorias para descobrir novos temas.</p>
					<p>Ou se preferir, procure na ordem alfabética. Aos poucos iremos introduzir novas palavras.</p>
		...
		<div class="container my-4">
			...
			<div class="row g-3">
				...
				<!-- Item 3 -->
				<div class="col-6 col-md-4 col-lg-2">
					<a type="button" class="btn btn-primary w-100 collapse-toggle" data-target="#panel3">
						Apostasia
					</a>
		...
		<!-- JS: comportamento “abre/fecha no mesmo” e “fecha os outros” -->
		<script>
