<div class="container">
  ...
  <head>
    <title>Bits de Fé - Doutrina</title>
  </head>
  <div class="right d-flex justify-content-end mb-3">
    <button type="button" onclick="likePage('doutrina')" id="like-section" class="btn btn-success">Curta nosso Site👍 </button>
    <span id="like-count"></span>
  </div>
  <div class="row g-5">
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">

      <h2 class="display-8 mb-4">Entenda sobre Doutrina</h2>
    ...
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
      <h2 class="mb-4">Leia estes artigos...</h2>
          ...
          <div class="row g-4">
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><a href="">Quem é Deus?</a>
                  </p>
            ...
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><a href="">A Trindade</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text"><a href="">Quem é Jesus Cristo?</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">O Espírito Santo</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">A Salvação pela graça</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4" heigth="150">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">Fé e obras</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">Justificação</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">Regeneração</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">Santificação</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">Glorificação</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">A Igreja de Cristo</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">O Batismo</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
                  <p class="card-text"><a href="">A Ceia do Senho</a></p>
                  <!-- <a href="#" class="btn btn-primary">Ler mais</a> -->
                </div>
              </div>
            </div>
