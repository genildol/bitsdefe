<div class="container">
  ...
  <head>
    <title>Bits de Fé - Conselhos Bíblicos</title>
  </head>
  <div class="right d-flex justify-content-end mb-3">
    <button type="button" onclick="likePage('conselhos')" id="like-section" class="btn btn-success">Curta nosso Site👍 </button>
    <span id="like-count">
    </span>
  </div>
  <div class="row g-5">
      ...
      <section class="noticias bg-light py-5">
        <div class="container">
          ...
          <div class="row g-4">
            ...
            <div class="col-md-4">
              <div class="card h-100">
                <img src="https://raw.githubusercontent.com/genildol/bitsdefe/main/public/assets/images/img-1.jpg" class="card-img-top">
                <div class="card-body">
                  <!-- <h3 class="card-title">Notícia 3</h3> -->
