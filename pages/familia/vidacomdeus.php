<div class="container">
  <title>Bits de Fé - Vida com Deus</title>
  <div class="right d-flex justify-content-end mb-3">
    <button type="button" onclick="likePage('vidacomdeus')" id="like-section" class="btn btn-success">Curta nosso Site👍 </button>
    <span id="like-count"></span>
  </div>
  <div class="row g-5">
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
      <!-- <p class="fs-5 fw-medium text-primary">Get A Quote</p> -->
      <h2 class="display-8 mb-4">Uma vida com Deus</h2>
