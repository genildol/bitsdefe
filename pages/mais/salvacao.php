    ...
    <div class="container-xxl py-5">
      <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
          <h2 class="fs-4 fw-medium text-primary"><a href="">Mensagens de Jesus Cristo</a></h2>
          <h4 class="display-10 mb-5">Veja abaixo as princiais mensagens de Jesus Cristo</h4>
        </div>
        <div class="row g-4">
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
            <div class="team-item rounded overflow-hidden pb-4">
              <img class="img-fluid mb-4" src="img/team-1.jpg" alt="">
              <h5>Salvar o homem</h5>
              <span class="text-primary"><a href="">ver texto</a></span>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
            <div class="team-item rounded overflow-hidden pb-4">
              <img class="img-fluid mb-4" src="img/team-2.jpg" alt="">
              <h5>Formar discípulos</h5>
              <span class="text-primary"><a href="">ver texto</a></span>
            </div>
          </div>
