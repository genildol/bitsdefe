<div class="container">
  <title>Bits de Fé - Trabalho</title>
  <div class="right d-flex justify-content-end mb-3">
    <button type="button" onclick="likePage('trabalho')" id="like-section" class="btn btn-success">Curta nosso Site👍 </button>
    <span id="like-count">
  ...
  <div class="row g-5">
    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
      ...
      <!-- <div class="card" style="width: 18rem;">
        <img src="./public/assets/images/img_v_2.jpg" class="card-img-top" alt="...">
      </div> -->
    </div>
