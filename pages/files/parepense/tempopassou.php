<div class="container my-5">
  ...
  <head>
    <title>O tempo que passou não volta, mas pode ensinar -Bits de Fé</title>
  </head>
  ...
  <div class="row g-4">
    <h2 class="display-8 mb-4">O tempo que passou não volta, mas pode ensinar</h2>
    <!-- Card 1 -->
  ...
  <div class="container">
    <div class="row g-5">
      <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
        ...
        <p>Há lembranças que nos alegram e outras que nos ferem. O passado carrega acertos e erros, vitórias e derrotas, momentos de felicidade e de dor. Embora o tempo que passou não volte, ele pode ser uma fonte valiosa de aprendizado para o presente e o futuro.</p>

        <p>Refletir sobre o passado nos permite compreender melhor quem somos e como chegamos até aqui. As experiências vividas, sejam elas boas ou ruins, moldam nossa personalidade, nossos valores e nossas crenças. Ao revisitar essas memórias, podemos identificar padrões de comportamento, reconhecer nossos pontos fortes e fracos, e aprender com os erros cometidos.</p>

        <p>Além disso, o passado nos oferece lições importantes sobre resiliência, perdão e crescimento pessoal. As dificuldades enfrentadas podem nos ensinar a sermos mais fortes e a valorizarmos os momentos de alegria. O perdão, tanto para os outros quanto para nós mesmos, é uma chave para a liberdade emocional e espiritual.</p>
