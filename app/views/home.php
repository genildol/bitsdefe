                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                                <a href="quote.html" class="dropdown-item">A Bíblia</a>
                                <a href="feature.html" class="dropdown-item">O que é</a>
                                <a href="feature.html" class="dropdown-item">Quem foi</a>
                                <a href="team.html" class="dropdown-item">Antigo Testamento</a>
                                <a href="testimonial.html" class="dropdown-item">Novo Testamento</a>
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu bg-light rounded-0 rounded-bottom m-0">
                                <a href="feature.html" class="dropdown-item">Casamento</a>
                                <a href="testimonial.html" class="dropdown-item">Mocidade</a>
                                <a href="team.html" class="dropdown-item">Conselhos</a>
                                <a href="quote.html" class="dropdown-item">Santidade</a>
                                <a href="404.html" class="dropdown-item">Variados</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
